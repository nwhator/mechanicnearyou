jQuery(window).on('elementor:init', () => {
    ...
    function showModal() {
        ...
        var r_f = jQuery('<div style="width:100%; padding:1rem ; text-align:center ; font-size:medium;"><h4 style="font-size:x-large">Stay tuned!</h4>More incredible templates are on the way.</div>')
