...
if ( ! class_exists( 'Car_Repair_Mechanic_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Car_Repair_Mechanic_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Car_Repair_Mechanic_WPTT_WebFont_Loader( $url );
