  ...
  <?php if( get_theme_mod( 'car_repair_mechanic_metafields_date',true) != '' || get_theme_mod( 'car_repair_mechanic_metafields_author',true) != '' || get_theme_mod( 'car_repair_mechanic_metafields_comment',true) != '' || get_theme_mod( 'car_repair_mechanic_metafields_time',true) != '') { ?>
    <div class="post-info p-2 mb-2">
      <?php if( get_theme_mod( 'car_repair_mechanic_metafields_date',true) != '') { ?>
        <i class="<?php echo esc_attr(get_theme_mod('car_repair_mechanic_postdate_icon',"fa fa-calendar pe-2" )); ?>"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><span class="entry-date pe-3"><?php echo esc_html( get_the_date() ); ?></span><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a>
      <?php }?>
      <?php if( get_theme_mod( 'car_repair_mechanic_metafields_author',true) != '') { ?>
        <i class="<?php echo esc_attr(get_theme_mod('car_repair_mechanic_postauthor_icon',"fa fa-user pe-2" )); ?>"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><span class="entry-author pe-3"> <?php the_author(); ?></span><span class="screen-reader-text"><?php the_author(); ?></span></a>
      <?php }?>
      <?php if( get_theme_mod( 'car_repair_mechanic_metafields_comment',true) != '') { ?>
        <i class="<?php echo esc_attr(get_theme_mod('car_repair_mechanic_postcomment_icon',"fa fa-comments pe-2" )); ?>"></i><span class="entry-comments pe-3"> <?php comments_number( __('0 Comments','car-repair-mechanic'), __('0 Comments','car-repair-mechanic'), __('% Comments','car-repair-mechanic') ); ?></span> 
      <?php }?>
      <?php if( get_theme_mod( 'car_repair_mechanic_metafields_time',true) != '') { ?>
        <i class="<?php echo esc_attr(get_theme_mod('car_repair_mechanic_posttime_icon',"fa fa-clock pe-2" )); ?>"></i> <span class="entry-comments pe-3"> <?php echo esc_html( get_the_time() ); ?></span>
      <?php }?>
    </div>
  <?php }?>
