...
class Car_Repair_Mechanic_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'car-repair-mechanic'); ?>">
                      </div>
                    <?php
                    $car_repair_mechanic_font_awesome_icon_array = car_repair_mechanic_font_awesome_icon_array();
                    foreach ($car_repair_mechanic_font_awesome_icon_array as $car_repair_mechanic_font_awesome_icon) {
                            $icon_class = $this->value() == $car_repair_mechanic_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($car_repair_mechanic_font_awesome_icon).'"></i>
                            <span class="car-repair-mechanic-social-class">'.esc_attr($car_repair_mechanic_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function car_repair_mechanic_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'car_repair_mechanic_customizer_script' );

if(!function_exists('car_repair_mechanic_font_awesome_icon_array')){
    function car_repair_mechanic_font_awesome_icon_array(){
