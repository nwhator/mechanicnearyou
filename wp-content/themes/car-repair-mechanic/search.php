                ...
                <div class="container"> 
                    <div class="row">       
                        <div class="col-lg-9 col-md-9">
                            <h1 class="search-title text-center mb-4"><?php /* translators: %s: search term */ printf(esc_html('Search Results for: %s','car-repair-mechanic'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
